...
var hljs = function () {
        ...
        const h = "[a-zA-Z]\\w*", E = "[a-zA-Z_]\\w*", y = "\\b\\d+(\\.\\d+)?",
        ...
        var C = Object.freeze({
            ...
            }, TITLE_MODE: {scope: "title", begin: h, relevance: 0},
            ...
            (e => {
                ...
                if (Array.isArray(e.begin)) {
                    ...
                    if ("object" != typeof e.beginScope || null === e.beginScope) throw P("beginScope must be object"),
                        H;
                    Z(e, e.begin, {key: "beginScope"}), e.begin = f(e.begin, {joinWith: ""})
                }
            })(e), (e => {
                if (Array.isArray(e.end)) {
                    ...
                    if ("object" != typeof e.endScope || null === e.endScope) throw P("endScope must be object"),
                        H;
                    Z(e, e.end, {key: "endScope"}), e.end = f(e.end, {joinWith: ""})
                }
            })(e)
        }
        ...
        function W(e) {
            ...
            return e.classNameAliases = s(e.classNameAliases || {}), function t(i, r) {
                ...
                [R, B, G, $].forEach((e => e(i, r))), e.compilerExtensions.forEach((e => e(i, r))),
                    i.__beforeBegin = null, [D, I, L].forEach((e => e(i, r))), i.isCompiled = !0;
                let l = null
                ;
        ...
        ;var Y = (e => {
            ...
            function m(e, t) {
                ...
                const a = (e => {
                    ...
                    })(e), i = t.filter(h).filter(y).map((n => b(n, e, !1)))
                ;i.unshift(a);
                const s = i.sort(((e, n) => {
                        if (e.relevance !== n.relevance) return n.relevance - e.relevance
                            ;
                        if (e.language && n.language) {
                            if (h(e.language).supersetOf === n.language) return 1
                                ;
                            if (h(n.language).supersetOf === e.language) return -1
                        }
                        return 0
                    })), [r, o] = s, c = r
                ;
            ...
            function p(e) {
                ...
                const t = (e => {
                    ...
                    return n.split(/\s+/).find((e => g(e) || h(e)))
                })(e);
                if (g(t)) return
                    ;
            ...
            "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
                ...
                highlight: u, highlightAuto: m, highlightAll: f,
                highlightElement: p,
        ...
        const ge = "[A-Za-z$_][0-9A-Za-z$_]*",
            ...
            fe = ["arguments", "this", "super", "console", "window", "document", "localStorage", "module", "global"],
            he = [].concat(_e, me, pe)
        ;
        ...
        function Ee(e) {
            ...
            const p = [].concat(u, o.contains), _ = p.concat([{
                ...
                label: "func.def", contains: [f], illegal: /%/
            }, N = {
        ...
        ;var ze = Object.freeze({
            ...
            grmr_python_repl: e => ({
                ...
                return {
                    ...
                    illegal: /->/, keywords: {
                        ...
                        contains: [{
                            className: "doctag", begin: "@examples",
                            starts: {
            ...
            grmr_swift: e => {
                const n = {match: /\s+/, relevance: 0}, t = e.COMMENT("/\\*", "\\*/", {
                    ...
                    begin: b(e, /"""/),
                    end: b(/"""/, e), contains: [h(e), E(e), y(e)]
                }), w = (e = "") => ({
                    begin: b(e, /"/),
                    end: b(/"/, e), contains: [h(e), y(e)]
                }), v = {
                    className: "string",
                ...
                }, {className: "keyword", match: b(/@/, m(...Le))}, {
                ...
                ;const A = {
                        ...
                        }, ...a, ...c, ...p, f, v, ...x, S, A], endsParent: !0, illegal: /["']/
                    }, R = {
                        ...
                        begin: [/precedencegroup/, /\s+/, Be], className: {
                            1: "keyword", 3: "title"
